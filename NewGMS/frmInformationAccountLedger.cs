...
namespace NewGMS
{
    public partial class frmInformationAccountLedger : Form
    {
        public frmInformationAccountLedger()
        {
            InitializeComponent();
        }

        private void frmInformationAccountLedger_Load(object sender, EventArgs e)
        {
            CmbLoad();
        }
        ...
        {
           // rptInformationLedger oRpt = new rptInformationLedger();      
