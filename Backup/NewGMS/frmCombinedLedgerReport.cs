...
namespace NewGMS
{
    public partial class frmCombinedLedgerReport : Form
    {
        public frmCombinedLedgerReport()
        {
            InitializeComponent();
        }
        ...
        {
            rptCombinedLedger oRpt = new rptCombinedLedger();            
        ...
        private void frmCombinedLedgerReport_Load(object sender, EventArgs e)
        {
            CmbLoad();
        }
